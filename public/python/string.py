...
personName = "Eddard Stark, Lord of Winterfell"

print personName

# String functions .lower() and .upper() with a variable
...
print personName.find('Lord')

# String function .replace()

print personName.replace('Winterfell', "King's Landing")

# String function .split() and join()

personNameArray = personName.split(" ") 

print personNameArray

print " ".join(personNameArray)